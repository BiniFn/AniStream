	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					'bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 border dark:text-foreground',
